...
const articleList = function () {
    ...
    for (let i = 0; i < 10; i++) {
      let newObject = {
        _id:Random.natural(10,12),
        title: Random.csentence(5, 40),
        author_name:Random.cname(),
        author_id:Random.natural(10,12),
        content:Random.csentence(65, 65),
        cover_img:Random.image('200x100', '#4A7BF7', 'Hello')
      }
      list.push(newObject)
    }
    console.log(list)
    return {data:{list,count:69},code:0}
}
...
Mock.mock('/api/article', 'get', articleList)   //1.
